...
const NigerianWavesBackground = () => {
  ...
  useEffect(() => {
    ...
    // Deeper, more saturated green to keep luminance steady while adding richness
    const svg = "<svg xmlns='http://www.w3.org/2000/svg' width='900' height='600' viewBox='0 0 3 2'><rect width='3' height='2' fill='#009240'/><rect x='1' width='1' height='2' fill='#ffffff'/></svg>";
